      ...
      >
        {({ errors }) => (
          <Form action="" className="formulario">
            <small className="form-campo-obligatorio">* Representa campo obligatorio</small>
            <div>
              <label htmlFor="dni"><small className="campo-obligatorio">*</small> DNI (sin puntos ni espacios)</label>
              <Field
                type="number"
                name="dni"
            ...
            <div>
              <label htmlFor="nombre"><small className="campo-obligatorio">*</small> Nombre</label>
              <Field
                type="text"
                name="nombre"
            ...
            <div>
              <label htmlFor="apellido"><small className="campo-obligatorio">*</small> Apellido</label>
              <Field
                type="text"
                name="apellido"
            ...
            <div>
              <label htmlFor="genero"><small className="campo-obligatorio">*</small> Género</label>
            ...
            <div>
              <h5><small className="campo-obligatorio">*</small> ¿Se encuentra trabajando actualmente?</h5>
              <label>
            ...
            <div>
              <label htmlFor="correo"><small className="campo-obligatorio">*</small> Correo</label>
              <Field
                type="text"
                name="correo"
            ...
            {success && (
              <>
                <p className="exito">
                  ...
                  <br />
                  Vas a recibir la aprobación en tu correo electrónico: {correo}
                </p>
                <Link className="btn-volver-inicio" to='/'>Volver al inicio</Link>
              </>
            )}
          </Form>
        )}
